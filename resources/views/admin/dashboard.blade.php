...
@section('konten')
    ...
    <script>
        ...
        //kodingan diatas memanggil variabel produkdata yang dikirim compact dari
        //dashboardcontroller
        ...
        var data = produkData.map(function(item) {
            return item.harga_jual; //map ada fungsi untuk mengurutkan data
        });
        //var data mendeklrasikan data yang mengambil kolom harga_jual
        // Area Chart Example
