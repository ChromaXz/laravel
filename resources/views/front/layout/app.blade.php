...
<body>
    <!--ga tau bener atau engga penempatannya-->@include('sweetalert::alert')
    <!-- Navigation-->
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="dropdown-menu">
                    <div class="row total-header-section">
                        <div class="col-lg-6 col-sm-6 col-6">
                            <i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="badge badge-pill badge-danger">{{ count((array)
                    session('cart')) }}</span>
                        </div>
                        @php $total = 0 @endphp
                        ...
                        <div class="col-lg-6
                    col-sm-6 col-6 total-section text-right">
                ...
                cart-detail">
                            ...
                            <div class="col-lg-8
                col-sm-8 col-8 cart-detail-product">
