<?php
//dibuat dengan code: php artisan make:controller JenisProdukController --resource
...
// cara pertama: use DB;
//cara kedua: use illuminate\Support\Facades\DB;
...
class JenisProdukController extends Controller
{
    ...
    public function index()
    {
        ...
        //variabel jenis ini mendeklarasikan table yang diambil dari model
        ...
        //admin.jenis.index adalah tempat file yang dituju
        return view('admin.jenis.index', compact('jenis')); //ini cara pertama
        //cara kedua: return view('admin.jenis.index', ['jenis' => $jenis]);
    }
    ...
    public function store(Request $request)
    {
        ...
        // return view mengarahkan ke file sebelu, proses atau akan diproses
